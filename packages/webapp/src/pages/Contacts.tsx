...
function downloadTemplate(): void {
  ...
  saveBlob("contacts_template.xlsx", data, XLSX_MIME);
}
...
function ExcelTab() {
  ...
  function handleDownload() {
    try {
      downloadTemplate();
      showToast({ message: "template downloaded", type: "success" });
    } catch {
      showToast({ message: "could not generate template", type: "error" });
    }
  }
    ...
    <>
      ...
      <div className="contacts-import-section">
        <div className="import-section-header">
          ...
          <button className="btn-ghost" onClick={handleDownload}>↓ download template</button>
        </div>
